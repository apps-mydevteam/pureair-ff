...
import 'pop_up_invoice_model.dart';
export 'pop_up_invoice_model.dart';

class PopUpInvoiceWidget extends StatefulWidget {
  const PopUpInvoiceWidget({
    super.key,
  ...
  @override
  State<PopUpInvoiceWidget> createState() => _PopUpInvoiceWidgetState();
}

class _PopUpInvoiceWidgetState extends State<PopUpInvoiceWidget> {
  late PopUpInvoiceModel _model;
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  16.0, 16.0, 0.0, 8.0),
                              child: Text(
                                'Invoice no #${containerOrdersRow?.id?.toString()}',
                                style: FlutterFlowTheme.of(context)
                                    .titleSmall
                                    .override(
                                      fontFamily: 'Montserrat',
