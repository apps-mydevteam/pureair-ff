    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case ActiveStorageBlobsRow:
            return ActiveStorageBlobsRow(data);
          case ServiceitemsRow:
            return ServiceitemsRow(data);
          case ColumnpreferencesRow:
            return ColumnpreferencesRow(data);
          case SettingsRow:
            return SettingsRow(data);
          case ArInternalMetadataRow:
            return ArInternalMetadataRow(data);
          case AddressesRow:
            return AddressesRow(data);
          case CustomeraddressesRow:
            return CustomeraddressesRow(data);
          case TeamregionsRow:
            return TeamregionsRow(data);
          case InvoicesRow:
          ...
          case ServicecontractsRow:
            return ServicecontractsRow(data);
          case ReviewsRow:
          ...
          case EnquiriesRow:
            return EnquiriesRow(data);
          case ContractitemsRow:
            return ContractitemsRow(data);
          case OrderitemsRow:
            return OrderitemsRow(data);
          case TeamsRow:
            return TeamsRow(data);
          case ActiveStorageVariantRecordsRow:
            return ActiveStorageVariantRecordsRow(data);
          case ActiveStorageAttachmentsRow:
            return ActiveStorageAttachmentsRow(data);
          case CustomersRow:
            return CustomersRow(data);
          case EmployeeregionsRow:
            return EmployeeregionsRow(data);
          case OrdersRow:
