...
import 'booking2_copy_model.dart';
export 'booking2_copy_model.dart';

class Booking2CopyWidget extends StatefulWidget {
  const Booking2CopyWidget({
    super.key,
    bool? devmode,
  ...
  @override
  State<Booking2CopyWidget> createState() => _Booking2CopyWidgetState();
}

class _Booking2CopyWidgetState extends State<Booking2CopyWidget> {
  late Booking2CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Booking2CopyModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<CustomersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CustomersRow> booking2CopyCustomersRowList = snapshot.data!;

        final booking2CopyCustomersRow = booking2CopyCustomersRowList.isNotEmpty
            ? booking2CopyCustomersRowList.first
            : null;
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            count: _model.countControllerValue6 ??=
                                                                                0,
                                                                            updateCount: (count) =>
                                                                                setState(() => _model.countControllerValue6 = count),
                                                                            stepSize:
                                                                                1,
                                                                            minimum:
                                                                                0,
