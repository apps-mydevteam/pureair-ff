...
import 'booking22_copy_model.dart';
export 'booking22_copy_model.dart';

class Booking22CopyWidget extends StatefulWidget {
  const Booking22CopyWidget({
    super.key,
    bool? devmode,
  ...
  @override
  State<Booking22CopyWidget> createState() => _Booking22CopyWidgetState();
}

class _Booking22CopyWidgetState extends State<Booking22CopyWidget> {
  late Booking22CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Booking22CopyModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<CustomersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CustomersRow> booking22CopyCustomersRowList = snapshot.data!;

        final booking22CopyCustomersRow =
            booking22CopyCustomersRowList.isNotEmpty
                ? booking22CopyCustomersRowList.first
                : null;
                                            ...
                                            child: Padding(
                                              ...
                                              child: FutureBuilder<
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  List<ServicesRow>
                                                      expandableServicesRowList =
                                                      snapshot.data!;

                                                  final expandableServicesRow =
                                                      expandableServicesRowList
                                                              .isNotEmpty
                                                          ? expandableServicesRowList
                                                              .first
                                            ...
                                            child: Padding(
                                              ...
                                              child: FutureBuilder<
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  List<ServiceitemsRow>
                                                      expandableServiceitemsRowList =
                                                      snapshot.data!;

                                                  final expandableServiceitemsRow =
                                                      expandableServiceitemsRowList
                                                              .isNotEmpty
                                                          ? expandableServiceitemsRowList
                                                              .first
                                                                        ...
                                                                        children: [
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              updateCount: (count) => setState(() => _model.countControllerValue4 = count),
                                                                              stepSize: 1,
                                                                              minimum: 0,
                                                                              maximum: 10,
                                                                              contentPadding: EdgeInsetsDirectional.fromSTEB(10.0, 0.0, 10.0, 0.0),
                                                                        ...
                                                                        children: [
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              updateCount: (count) => setState(() => _model.countControllerValue5 = count),
                                                                              stepSize: 1,
                                                                              minimum: 0,
                                                                              maximum: 10,
                                                                              contentPadding: EdgeInsetsDirectional.fromSTEB(10.0, 0.0, 10.0, 0.0),
                                                                        ...
                                                                        children: [
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              updateCount: (count) => setState(() => _model.countControllerValue6 = count),
                                                                              stepSize: 1,
                                                                              minimum: 0,
                                                                              maximum: 10,
                                                                              contentPadding: EdgeInsetsDirectional.fromSTEB(10.0, 0.0, 10.0, 0.0),
                                                                        ...
                                                                        children: [
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              updateCount: (count) => setState(() => _model.countControllerValue7 = count),
                                                                              stepSize: 1,
                                                                              minimum: 0,
                                                                              maximum: 10,
                                                                              contentPadding: EdgeInsetsDirectional.fromSTEB(10.0, 0.0, 10.0, 0.0),
                                      ...
                                      children: [
                                        Align(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              context.pushNamed('Booking2Copy');
                                            },
                                            text: 'Back',
