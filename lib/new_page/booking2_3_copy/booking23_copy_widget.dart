...
import 'booking23_copy_model.dart';
export 'booking23_copy_model.dart';

class Booking23CopyWidget extends StatefulWidget {
  const Booking23CopyWidget({
    super.key,
    bool? devmode,
  ...
  @override
  State<Booking23CopyWidget> createState() => _Booking23CopyWidgetState();
}

class _Booking23CopyWidgetState extends State<Booking23CopyWidget> {
  late Booking23CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Booking23CopyModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<CustomersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CustomersRow> booking23CopyCustomersRowList = snapshot.data!;

        final booking23CopyCustomersRow =
            booking23CopyCustomersRowList.isNotEmpty
                ? booking23CopyCustomersRowList.first
                : null;
