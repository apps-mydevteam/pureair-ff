...
import 'booking22_model.dart';
export 'booking22_model.dart';

class Booking22Widget extends StatefulWidget {
  const Booking22Widget({
    super.key,
    bool? devmode,
  ...
  @override
  State<Booking22Widget> createState() => _Booking22WidgetState();
}

class _Booking22WidgetState extends State<Booking22Widget> {
  late Booking22Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Booking22Model());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<CustomersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CustomersRow> booking22CustomersRowList = snapshot.data!;

        final booking22CustomersRow = booking22CustomersRowList.isNotEmpty
            ? booking22CustomersRowList.first
            : null;
