...
import 'booking_form2_model.dart';
export 'booking_form2_model.dart';

class BookingForm2Widget extends StatefulWidget {
  const BookingForm2Widget({
    super.key,
    bool? devmode,
    bool? needLeader,
  ...
  @override
  State<BookingForm2Widget> createState() => _BookingForm2WidgetState();
}

class _BookingForm2WidgetState extends State<BookingForm2Widget> {
  late BookingForm2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookingForm2Model());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<CustomersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CustomersRow> bookingForm2CustomersRowList = snapshot.data!;

        final bookingForm2CustomersRow = bookingForm2CustomersRowList.isNotEmpty
            ? bookingForm2CustomersRowList.first
            : null;
                                    ...
                                    FutureBuilder<List<ServicesRow>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        final listViewServicesRow =
                                            listViewServicesRowList.isNotEmpty
                                                ? listViewServicesRowList.first
                                                : null;
                                                                                    ...
                                                                                    updateCount: (count) async {
                                                                                      ...
                                                                                      FFAppState().addToCart(CartStruct(
                                                                                        ...
                                                                                        total: valueOrDefault<double>(
                                                                                          ((_model.countControllerValue1!) * 50).toDouble(),
                                                                                          0.0,
                                                                                        ),
                                                                                      ));
                                                                                      safeSetState(() {});
                                                                                      _model.totalCart = await actions.sumCartTotal();
                                                                                      FFAppState().totalCart = valueOrDefault<double>(
                                                                                        _model.totalCart,
                                                                                        0.0,
                                                                                      );
                                                                                      safeSetState(() {});
                                                                              ...
                                                                              children: [
                                                                                Container(
                                                                                  ...
                                                                                  child: FlutterFlowCountController(
                                                                                    ...
                                                                                    count: _model.countControllerCtrValue ??= 0,
                                                                                    updateCount: (count) async {
                                                                                      safeSetState(() => _model.countControllerCtrValue = count);
                                                                                      FFAppState().cart = [];
                                                                                      safeSetState(() {});
                                                                                      FFAppState().addToCart(CartStruct(
                                                                                        serviceitemId: 1,
                                                                                        quantity: valueOrDefault<int>(
                                                                                          _model.countControllerCtrValue,
                                                                                          0,
                                                                                        ),
                                                                                        total: 0.0,
                                                                                      ));
                                                                                      safeSetState(() {});
                                                                                      _model.totalCart2 = await actions.sumCartTotal();
                                                                                      FFAppState().totalCart = valueOrDefault<double>(
                                                                                        _model.totalCart2,
                                                                                        0.0,
                                                                                      );
                                                                ...
                                                                Align(
                                                                  alignment:
                                                                      AlignmentDirectional(
                                                                          ...
                                                                          0.0),
                                                                  child: Text(
                                                                    'Save up to 28% (bef. GST). \nDiscover pricing details here.',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .labelLarge
                                                                        .override(
                                                              ...
                                                              return wrapWithModel(
                                                                ...
                                                                updateCallback: () =>
                                                                    safeSetState(
                                                                        () {}),
                                                                child:
                                                                    ServicesItemFieldWidget(
                                                                  key: Key(
                                                                    'Keyp6a_${columnServiceitemsRow.id.toString()}',
                                                                  ),
                                                                  serviceitemname:
                                                                      valueOrDefault<
                                                                          String>(
                                                            ...
                                                            Align(
                                                              alignment:
                                                                  AlignmentDirectional(
                                                                      ...
                                                                      0.0),
                                                              child: Text(
                                                                'Please note, a transportation fee of \$50 + GST will be applied.',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .labelLarge
                                                                    .override(
                                                                ...
                                                                Align(
                                                                  alignment:
                                                                      AlignmentDirectional(
                                                                          ...
                                                                          0.0),
                                                                  child: Text(
                                                                    'After submission, we\'ll contact you \nwith a quote.',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .labelLarge
                                                                        .override(
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            count: _model.countControllerValue4 ??=
                                                                                0,
                                                                            updateCount: (count) =>
                                                                                safeSetState(() => _model.countControllerValue4 = count),
                                                                            stepSize:
                                                                                1,
                                                                            minimum:
                                                                                0,
