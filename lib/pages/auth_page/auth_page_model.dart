...
class AuthPageModel extends FlutterFlowModel<AuthPageWidget> {
  ...
  // Stores action output result for [Backend Call - API (Create User API CRM)] action in Button-Regist widget.
  ApiCallResponse? apiResultSignUp;
  // Stores action output result for [Backend Call - API (Create User Supabase)] action in Button-Regist widget.
