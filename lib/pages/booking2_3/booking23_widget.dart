...
import 'booking23_model.dart';
export 'booking23_model.dart';

class Booking23Widget extends StatefulWidget {
  const Booking23Widget({
    super.key,
    bool? devmode,
  ...
  @override
  State<Booking23Widget> createState() => _Booking23WidgetState();
}

class _Booking23WidgetState extends State<Booking23Widget> {
  late Booking23Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Booking23Model());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<CustomersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CustomersRow> booking23CustomersRowList = snapshot.data!;

        final booking23CustomersRow = booking23CustomersRowList.isNotEmpty
            ? booking23CustomersRowList.first
            : null;
