  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<CustomersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CustomersRow> homePageCopyCustomersRowList = snapshot.data!;

        final homePageCopyCustomersRow = homePageCopyCustomersRowList.isNotEmpty
            ? homePageCopyCustomersRowList.first
            : null;
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      mainAxisAlignment:
                                                                          MainAxisAlignment
                                                                              .spaceBetween,
                                                                      children: [
                                                                        if (bookListOrdersRow.contractId ==
                                                                            null)
                                                                          Align(
                                                                            alignment:
                                                                                AlignmentDirectional(-1.0, 0.0),
                                                                    ...
                                                                    FutureBuilder<
                                                                      ...
                                                                      future: FFAppState()
                                                                          .orderItems(
                                                                        uniqueQueryKey: bookListOrdersRow
                                                                            .id
                                                                            .toString(),
                                                                        requestFn:
                                                                            () =>
                                                                        ...
                                                                        return ListView
                                                                          ...
                                                                          itemBuilder:
                                                                            ...
                                                                            return Align(
                                                                              ...
                                                                              child: FutureBuilder<List<ServiceitemsRow>>(
